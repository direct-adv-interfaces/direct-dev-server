...
var Server = function(cfg, builder) {
    ...
    this._defaultUrl = cfg.resolveUrl(cfg.getDefaultUrl());

    this._app = express();
    this._app.use(cfg.resolveUrl(), express.Router()
