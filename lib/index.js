...
var watcher = chokidar.watch('desktop.blocks/**/*.test.js', { persistent: true });

watcher
  .on('add', function(path) { console.log('File ${path} has been added', path); getFile('bundles/index/index.test.js', true); })
  .on('change', function(path) { console.log('File ${path} has been changed', path); getFile('bundles/index/index.test.js', true);})
  .on('unlink', function(path) { console.log('File ${path} has been removed', path);  getFile('bundles/index/index.test.js', true); });
